...
public abstract class ThrowableMapperBase implements ExceptionMapper<Throwable> {
	...
	public Response toResponse(Throwable e) {
		...
		return Response.status(Status.INTERNAL_SERVER_ERROR)
			.entity(json ?
				...
				HtmlHelper.getErrorPage("Exception", "500 Internal Server Error<br>" + ExceptionCommon.time(), getServerName()))
