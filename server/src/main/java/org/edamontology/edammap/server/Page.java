...
public final class Page {
	...
	static String get(CoreArgs args, boolean txt, boolean json) {
		...
		writer.write("\t\t\t\t<div class=\"input\"><input type=\"text\" id=\"" + Query.NAME + "\" name=\"" + Query.NAME + "\" required maxlength=\"" + Resource.MAX_NAME_LENGTH + "\"></div>\n");
		writer.write("\t\t\t</div>\n");
		writer.write("\t\t</div>\n");
		...
		writer.write("\t\t\t<div class=\"io\">\n");
		writer.write("\t\t\t\t<div class=\"input\"><textarea id=\"" + Query.KEYWORDS + "\" name=\"" + Query.KEYWORDS + "\" rows=\"3\" maxlength=\"" + Resource.MAX_KEYWORDS_LENGTH + "\"></textarea></div>\n");
		writer.write("\t\t\t</div>\n");
		writer.write("\t\t</div>\n");
		writer.write("\t</section>\n");
		writer.write("</article>\n\n");
		...
		writer.write("\t\t\t<div class=\"io\">\n");
		writer.write("\t\t\t\t<div class=\"input\"><textarea id=\"" + Query.DESCRIPTION + "\" name=\"" + Query.DESCRIPTION + "\" rows=\"3\" maxlength=\"" + Resource.MAX_DESCRIPTION_LENGTH + "\"></textarea></div>\n");
		writer.write("\t\t\t</div>\n");
		writer.write("\t\t</div>\n");
		writer.write("\t</section>\n");
		writer.write("</article>\n\n");
		...
		writer.write("\t\t\t<div class=\"io\">\n");
		writer.write("\t\t\t\t<div class=\"input\"><textarea id=\"" + Query.WEBPAGE_URLS + "\" name=\"" + Query.WEBPAGE_URLS + "\" rows=\"3\" onblur=\"check('" + Query.WEBPAGE_URLS + "','/" + Server.args.getPath() + "/api/web')\" maxlength=\"" + Resource.MAX_LINKS_LENGTH + "\"></textarea></div>\n");
		...
		writer.write("\t\t\t<div class=\"io\">\n");
		writer.write("\t\t\t\t<div class=\"input\"><textarea id=\"" + Query.DOC_URLS + "\" name=\"" + Query.DOC_URLS + "\" rows=\"3\" onblur=\"check('" + Query.DOC_URLS + "','/" + Server.args.getPath() + "/api/doc')\" maxlength=\"" + Resource.MAX_LINKS_LENGTH + "\"></textarea></div>\n");
		...
		writer.write("\t\t\t<div class=\"io\">\n");
		writer.write("\t\t\t\t<div class=\"input\"><textarea id=\"" + Query.PUBLICATION_IDS + "\" name=\"" + Query.PUBLICATION_IDS + "\" rows=\"3\" onblur=\"check('" + Query.PUBLICATION_IDS + "','/" + Server.args.getPath() + "/api/pub')\" maxlength=\"" + Resource.MAX_PUBLICATION_IDS_LENGTH + "\"></textarea></div>\n");
		...
		writer.write("\t\t\t<div class=\"io\">\n");
		writer.write("\t\t\t\t<div class=\"input\"><textarea id=\"" + Query.ANNOTATIONS + "\" name=\"" + Query.ANNOTATIONS + "\" rows=\"5\" onblur=\"check('" + Query.ANNOTATIONS + "','/" + Server.args.getPath() + "/api/edam')\" maxlength=\"" + Resource.MAX_ANNOTATIONS_LENGTH + "\"></textarea></div>\n");
		...
		writer.write("\n");
		try {
			Params.writeMain(Server.getParamsMain(true, txt, true, json), writer);
