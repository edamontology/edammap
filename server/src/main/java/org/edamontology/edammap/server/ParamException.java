...
public class ParamException extends WebApplicationException {
	...
	ParamException(String key, String value, String reason) {
		super(Response.status(Status.BAD_REQUEST).entity("Param \"" + key + "=" + value + "\" " + reason).type(MediaType.TEXT_PLAIN).build());
	}
}
